...
import { FooterDownloadComponent } from './download.component';

describe('DownloadFooterComponent', () => {
  ...
  it('Should test ngoninit', inject([FooterService],(footerService:FooterService) => {
    ...
    component.ngOnInit();
    expect(component.DownloadInfo.length).toBe(5);
  }));
  it('Should test geturl function',() => {
    let result = component.getUrl('test');
