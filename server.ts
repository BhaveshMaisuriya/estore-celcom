...
import * as tokenStore from "./src/controller/tokenStore";
...
app.use("/rest/V1/ekyc", (eKycRoutes as any));
...
app.all('/rest/V1/questionRetrive', authenticateRoute);
app.all('/rest/V1/questionSubmit', authenticateRoute);
...
app.post("/rest/V1/gamificationEligibility", (req, res) => {
  // logger.debug(commonUtils.getObjectForLoggingForRoutes(req, __filename));
  apiController.postEstoreDataWithOauth(req, res); 
});
...
app.post("/rest/V1/prepaidaddtocart", (req, res) => {
  // logger.debug(commonUtils.getObjectForLoggingForRoutes(req, __filename));
  newApiController.userLoginAndTrackorder(req, res);
});
app.post("/rest/V1/prepaid-login", (req, res) => {
  // logger.debug(commonUtils.getObjectForLoggingForRoutes(req, __filename));
  newApiController.userLoginAndTrackorder(req, res);
});
...
app.post("/userDealerMap", (req, res) => {
  ...
  console.log('agent-dealer-login-customer : ' + JSON.stringify(ob));
  res.send(200);
})
